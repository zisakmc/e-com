			...
			<div class="py-6 md:py-0 md:px-6">
				...
				<div class="space-y-4">
					<p class="flex items-center">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 mr-2 sm:mr-6" style="--darkreader-inline-fill: currentColor;" data-darkreader-inline-fill="">
